...
export default function Download({ files, state, setState }) {
	...
	return (
		<div className={'top-1/2 left-1/2 z-10 shadow-2xl w-max duration-300 font-semibold leading-relaxed fixed border-2 border-gray-400 bg-[--bg] p-6 rounded -translate-x-1/2 transition-[top] download -translate-y-1/2 ' + (!state && 'top-[150%]')}>
